            ...
            <div className="mx-auto grid min-h-180 max-w-5xl overflow-hidden rounded-[28px] border border-stone-200 bg-white shadow-[0_30px_80px_rgba(28,25,23,0.08)] transition-colors lg:grid-cols-[1.08fr_0.92fr] dark:border-stone-800 dark:bg-stone-900 dark:shadow-[0_30px_80px_rgba(0,0,0,0.3)]">
                ...
                <div className="flex flex-col bg-[#f9f7f4] p-6 transition-colors sm:p-8 lg:p-10 dark:bg-stone-900">
                    <div className="mb-8">
                        ...
                        <p className="text-sm font-medium uppercase tracking-[0.18em] text-stone-500 dark:text-stone-400">Join us</p>
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5" noValidate>
                        <Field>
                            <FieldLabel htmlFor="username" className="text-sm font-medium text-stone-700 dark:text-stone-300">
                                Username
                            </FieldLabel>
                            <FieldContent>
                        ...
                        <Field>
                            <FieldLabel htmlFor="email" className="text-sm font-medium text-stone-700 dark:text-stone-300">
                                Email
                            </FieldLabel>
                            <FieldContent>
                                <Input
